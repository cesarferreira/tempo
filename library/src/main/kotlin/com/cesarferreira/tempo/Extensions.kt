...
fun Long.removeMinutes(minutes: Int) = manipulateTime(this, minutes, Calendar.MINUTE, isPast = true)
...
fun Long.addHours(hours: Int) = manipulateTime(this, hours, Calendar.HOUR, isPast = false)
fun Long.removeHours(hours: Int) = manipulateTime(this, hours, Calendar.HOUR, isPast = true)

fun Date.addHours(hours: Int) = this.time.addHours(hours)
fun Date.removeHours(hours: Int) = this.time.addHours(hours)

private fun manipulateTime(currentTime: Long, amount: Int, calendarField: Int, isPast: Boolean): Date {
